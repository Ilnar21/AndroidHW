...
public final class FragmentDisplayBinding implements ViewBinding {
  ...
  private FragmentDisplayBinding(@NonNull RelativeLayout rootView,
      @NonNull TextView displayTextView) {
  ...
  public static FragmentDisplayBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.displayTextView;
      TextView displayTextView = ViewBindings.findChildViewById(rootView, id);
      if (displayTextView == null) {
        break missingId;
      }

      return new FragmentDisplayBinding((RelativeLayout) rootView, displayTextView);
    }
